...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { amount: @donation.amount, date: @donation.date, method: @donation.method, recipient_id: @donation.recipient_id }
    end
  ...
  test "should update donation" do
    patch :update, id: @donation, donation: { amount: @donation.amount, date: @donation.date, method: @donation.method, recipient_id: @donation.recipient_id }
    assert_redirected_to donation_path(assigns(:donation))
  end
